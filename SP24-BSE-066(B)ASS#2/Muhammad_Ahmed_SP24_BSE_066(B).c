...
//SECTION (B)
//ASSIGNMENT NO 2
//Write a computer program which convert the data into any of the given units using the following table.
//In this program  b=bit,B=byte,K=kilobyte,M=megabyte,G=gigabyte,T=terabyte,P=pentabyte,E=exabyte
